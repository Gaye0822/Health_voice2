...
Usage:
    python export_envelopes.py                    # exports all envelopes
    python export_envelopes.py --limit 5          # exports last 5
    python export_envelopes.py --out ./output     # custom output directory
...
def export_envelopes(output_dir: str = "./exports", limit: int = None):
    """
...
if __name__ == "__main__":
    ...
    export_envelopes(output_dir=args.out, limit=args.limit)